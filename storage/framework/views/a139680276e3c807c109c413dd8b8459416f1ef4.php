...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-span-12">
						...
						<?php $__errorArgs = ['gettingmarried'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
							<p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
								<?php echo e($errors->first('gettingmarried')); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
							<p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
								<?php echo e($errors->first('weddingdate')); ?>
...
unset($__errorArgs, $__bag); ?>
			...
			<div class="mt-6">
				<div class="list-disc list-inside text-slate-500 text-[13px]">
					...
					<!-- <li> -->
					<p class="nmy text-center">Already a member? <a class="link-color hover:text-gray-800 hover:underline font-medium transition-colors duration-300" href="<?php echo e(url('auth/login')); ?>">
					Log in here
...
<script>
        $(document).ready(function() {
            $('#location-search').on('keyup', function() {
                ...
                if (query.length > 1) {
                    $.ajax({
                        url: '<?php echo e(route("search.locations")); ?>', // Update with your route
                        method: 'GET',
                        data: { query: query },
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\WedLively\resources\views/livewire/main/auth/register.blade.php ENDPATH**/ ?>