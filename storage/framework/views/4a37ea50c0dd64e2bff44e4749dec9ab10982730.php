			...
			<div class="mx-auto pt-12 pb-12 px-14 mb-24">
				  <div class="relative pt-6 pb-6 xl:col-start-1 text-center">
					...
					<div class="mt-12 text-center">
						<a href="<?php echo e(url('auth/vendor/register')); ?>" class="font-reselu inline-flex items-center rounded-sm border border-red-400 bg-transparent px-6 py-4 font-medium text-red-400 hover:text-white focus:text-white hover:bg-red-400 transition-colors duration-300 flex gap-2">
			...
			<?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div>
					<div class="group relative p-4 mb-5 min-h-[190px flex]">
						...
						<img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('public/img/start_selling/' . $seller['avatar'])); ?>" alt="<?php echo e($seller['name']); ?>" class="relative  shadow object-cover lazy">
					</div>
				  ...
				  <div class="mt-12 max-w-sm mx-auto grid grid-cols-1 gap-y-10 gap-x-8 sm:max-w-none lg:grid-cols-3">
					...
					<div class="text-center sm:flex sm:text-left lg:block lg:text-center">
						...
						<div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
							<h4 class="font-medium text-white"><?php echo e(__('messages.t_create_a_gig')); ?></h4>
							<p class="mt-2 text-white"><?php echo e(__('messages.t_start_selling_t_create_a_gig_subtitle')); ?></p>
						</div>
					</div>
					...
					<div class="text-center sm:flex sm:text-left lg:block lg:text-center">
						...
						<div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
							<h4 class="font-medium text-white"><?php echo e(__('messages.t_deliver_great_work')); ?></h4>
							<p class="mt-2 text-white"><?php echo e(__('messages.t_deliver_great_work_subtitle')); ?></p>
						</div>
					</div>
					...
					<div class="text-center sm:flex sm:text-left lg:block lg:text-center">
						...
						<div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
							<h4 class="font-medium text-white"><?php echo e(__('messages.t_get_paid')); ?></h4>
							<p class="mt-2 text-white"><?php echo e(__('messages.t_get_paid_subtitle')); ?></p>
						</div>
					</div>
	...
	<div class="mb-24 container xl:max-w-7xl mx-auto px-4 lg:px-8">
		...
		<div class="text-center mb-8">
			...
			<h2 class="text-3xl md:text-4xl font-extrabold mb-4 dark:text-gray-200">
				<?php echo app('translator')->get('messages.t_signup_and_create_ur_first_gig'); ?> <span class="text-red-400"><?php echo app('translator')->get('messages.t_today'); ?></span>!
			</h2>
...
<?php endif; ?>
		...
		<?php if(auth()->guard()->guest()): ?>
			<div class="text-center">
				<a href="<?php echo e(url('auth/vendor/register')); ?>" class="font-reselu inline-flex items-center rounded-sm border border-red-400 bg-red-400 px-6 py-4 font-medium text-white hover:text-red-500 focus:text-red-400 hover:bg-transparent transition-colors duration-300 flex gap-2">
...
</div><?php /**PATH C:\xampp\htdocs\WedLively\resources\views/livewire/main/become/seller.blade.php ENDPATH**/ ?>