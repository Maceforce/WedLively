...
<<<<<<< Updated upstream:storage/framework/views/3d34ce6a0dcbc4c9cafbd570065c647168afae14.php
    ...
    $_instance->preserveRenderedChild('TVyTMTe');
} else {
...
=======
    ...
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Z8XBPdN');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
...
} elseif ($_instance->childHasBeenRendered('T29jBrs')) {
    $componentId = $_instance->getRenderedChildComponentId('T29jBrs');
    $componentTag = $_instance->getRenderedChildComponentTagName('T29jBrs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('T29jBrs');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('T29jBrs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\freeluncer3\resources\views/livewire/main/layout/app.blade.php ENDPATH**/ ?>