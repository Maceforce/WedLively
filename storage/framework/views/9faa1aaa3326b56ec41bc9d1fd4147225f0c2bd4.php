...
unset($__errorArgs, $__bag); ?>
			...
			<div class="mt-6">
				<div class="list-disc list-inside text-slate-500 text-[13px] space-y-2">
					...
					<!-- <li> -->
						<a class="hover:text-slate-600 hover:underline link-color" href="<?php echo e(url('auth/password/reset')); ?>">
					...
					<!-- <li> -->
					<p class="nmy">Not a member Yet?<a class="hover:text-slate-600 hover:underline link-color" href="<?php echo e(url('auth/register')); ?>">
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\freeluncer\resources\views/livewire/main/auth/login.blade.php ENDPATH**/ ?>