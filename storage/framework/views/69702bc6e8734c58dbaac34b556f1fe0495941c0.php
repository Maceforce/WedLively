...
} elseif ($_instance->childHasBeenRendered('slizLDy')) {
    $componentId = $_instance->getRenderedChildComponentId('slizLDy');
    $componentTag = $_instance->getRenderedChildComponentTagName('slizLDy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('slizLDy');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('slizLDy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('AsBEN6W')) {
    $componentId = $_instance->getRenderedChildComponentId('AsBEN6W');
    $componentTag = $_instance->getRenderedChildComponentTagName('AsBEN6W');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AsBEN6W');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('AsBEN6W', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\freeluncer3\resources\views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>