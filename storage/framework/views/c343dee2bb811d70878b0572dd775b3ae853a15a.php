...
<?php endif; ?>
    ...
    <main class="max-w-7xl mx-auto">
        ...
        <div class="flex bg-white mt-4 shadow-md justify-between items-center mb-2 bg-transparent py-2 ltr:pr-6 rtl:pl-6 ltr:border-l-8 rtl:border-r-8 ltr:pl-4 rtl:pr-4 border-red-400 ">
            ...
            <div>
                <h2 class="font-semibold text-xl text-red-400 dark:text-red-400 pb-1 block tracking-wider"><?php echo e($subcategory->name); ?></h2>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\WedLively\resources\views/livewire/main/categories/subcategory.blade.php ENDPATH**/ ?>