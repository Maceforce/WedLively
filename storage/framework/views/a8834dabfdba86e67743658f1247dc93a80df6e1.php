<div class="flex w-full max-w-2xl grow flex-col justify-center px-4 py-4 lg:px-12 lg:py-12 shadow-md border border-gray-100 dark:border-zinc-700 signup-form" style="max-height:fit-content;">
	...
	<div class="text-center">
		<h2 class="text-2xl mb-0 font-bold text-gray-800 dark:text-navy-100">		 
			<span>Vendor Sign Up to SUKOONZZ</span>
				...
				<form x-data="window.UcZWcDFfVKBjfgP" x-on:submit.prevent="register" class="grid grid-cols-12 md:gap-x-6 gap-y-6">
					...
					<div class="col-span-12 lg:col-span-6">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="text" x-model="form.fullname" class="<?php echo e($errors->first('fullname') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-3 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_your_fullname')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12 lg:col-span-6">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="text" x-model="form.phone" class="<?php echo e($errors->first('phone') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-3 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter phone number">
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-span-12">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="email" x-model="form.email" class="<?php echo e($errors->first('email') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-3 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_email_address')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="text" x-model="form.username" class="<?php echo e($errors->first('username') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-3 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_username')); ?>">
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-span-12">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="password" x-model="form.password" class="<?php echo e($errors->first('password') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-3 placeholder:font-normal  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_password')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12">
                        <div class="flex items-center justify-center space-x-2 rtl:space-x-reverse -mt-5 mb-5">
					...
					<div class="col-span-12">
						<button type="submit" wire:loading.attr="disabled" wire:target="register" :disabled="!form.email || !form.password || !form.fullname || !form.username || !form.phone"  class="w-full inline-flex items-center justify-center rounded-sm border border-black bg-gray-800 p-3 font-medium text-white hover:text-gray-800 focus:text-gray-800 hover:bg-transparent transition-colors duration-300 cursor-pointer	">
			...
			<div class="mt-6">
				<div class="list-disc list-inside text-slate-500 text-[13px] space-y-2">
					...
					<!-- <li> -->
					<p class="nmy text-center">Already a member? <a class="hover:text-slate-600 hover:underline link-color" href="<?php echo e(url('auth/login')); ?>">
					Log in here
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\WedLively\resources\views/livewire/main/auth/vendorregister.blade.php ENDPATH**/ ?>