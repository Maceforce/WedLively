...
} elseif ($_instance->childHasBeenRendered('qNouIwe')) {
    $componentId = $_instance->getRenderedChildComponentId('qNouIwe');
    $componentTag = $_instance->getRenderedChildComponentTagName('qNouIwe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qNouIwe');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('qNouIwe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('uDQn40v')) {
    $componentId = $_instance->getRenderedChildComponentId('uDQn40v');
    $componentTag = $_instance->getRenderedChildComponentTagName('uDQn40v');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uDQn40v');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('uDQn40v', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/vidylyex/freelancerwork.online/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>