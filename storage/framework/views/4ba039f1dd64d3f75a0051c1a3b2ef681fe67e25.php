<div class="flex w-full max-w-md grow flex-col justify-center px-12 py-14 login-form shadow-md border border-gray-100 dark:border-zinc-700" style="max-height:fit-content;max-height:min-content;">
	...
	<div class="mt-3">
		...
		<div class="w-full relative">
			...
			<div class="">
				<form x-data="window.zyKtAkZuKbBmbfC" x-on:submit.prevent="login" class="grid grid-cols-12 md:gap-x-6 gap-y-3">
					...
					<div class="col-span-12">
						<div class="relative w-full shadow-sm">
							...
							<input type="email" x-model="form.email" class="<?php echo e($errors->first('email') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm font-medium block w-full ltr:pr-12 rtl:pl-12 p-3 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_email_address')); ?>">
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-span-12">
						<div class="relative w-full shadow-sm">
							...
							<input type="password" x-model="form.password" class="<?php echo e($errors->first('password') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm font-medium block w-full ltr:pr-12 rtl:pl-12 p-3 placeholder:font-normal  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_password')); ?>">
...
unset($__errorArgs, $__bag); ?>
			...
			<div class="mt-6 text-center">
				<div class="list-disc list-inside text-slate-500 text-[13px]">
					...
					<!-- <li> -->
						<a class="link-color hover:text-gray-800 hover:underline font-medium transition-colors duration-300" href="<?php echo e(url('auth/password/reset')); ?>">
							<?php echo app('translator')->get('messages.t_forgot_password'); ?>	<br><br>
						</a>
					<!-- </li> -->

					
					<!-- <li> -->
					<p class="nmy font-medium">Not a member Yet?<a class="link-color hover:text-gray-800 hover:underline font-medium transition-colors duration-300" href="<?php echo e(url('auth/register')); ?>">
							<!-- <?php echo app('translator')->get('messages.t_create_account'); ?>	 -->Sign up here
						</a></p>
					<!-- </li> -->
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\WedLively\resources\views/livewire/main/auth/login.blade.php ENDPATH**/ ?>