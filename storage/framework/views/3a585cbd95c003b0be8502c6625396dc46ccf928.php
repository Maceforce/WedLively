                    ...
                    <div class="flex h-full flex-col bg-white dark:bg-zinc-700 shadow-xl">
                        ...
                        <?php if(count($cart)): ?>
                            <div class="border-t border-gray-200 dark:border-zinc-600 py-6 px-4 sm:px-6">
                                ...
                                <div class="mt-6">
                                    <a href="<?php echo e(url('cart')); ?>" class="w-full inline-flex items-center justify-center rounded-sm border border-red-400 bg-red-400 p-3 font-medium text-white hover:text-red-500 focus:text-red-400 hover:bg-transparent transition-colors duration-300 font-reselu"><?php echo e(__('messages.t_view_cart')); ?></a>
                                </div>
                                <div class="mt-6 flex justify-center text-center text-sm text-gray-500 dark:text-gray-300">
                                    <p>
                                        <?php echo e(__('messages.t_or')); ?> <button type="button" class="font-medium text-red-400 hover:text-red-500" @click="cart_open = false"><?php echo e(__('messages.t_continue_shopping')); ?><span aria-hidden="true"> →</span></button>
                                    </p>
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\WedLively\resources\views/livewire/main/partials/cart.blade.php ENDPATH**/ ?>