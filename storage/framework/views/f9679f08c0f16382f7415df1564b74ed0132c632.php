                                ...
                                <dl class="grid grid-cols-1 gap-y-8 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <?php if($verification->status === 'verified'): ?>
                                            ...
                                            <dd class="mt-1 text-xs text-gray-500"><?php echo e(format_date($verification->verified_at, 'l m Y, h:m')); ?></dd>
                                        <?php endif; ?>

                                        
                                        <?php if($verification->status === 'pending'): ?>
                                            <dt class="text-sm font-medium text-gray-500"><?php echo e(__('messages.t_verification_date')); ?></dt>
                                            <dd class="mt-1 text-xs text-gray-500"><?php echo e(format_date($verification->created_at, 'l m Y, h:m')); ?></dd>
                                        <?php endif; ?>

                                        
                                        <?php if($verification->status === 'declined'): ?>
                                            <dt class="text-sm font-medium text-gray-500"><?php echo e(__('messages.t_declined_at')); ?></dt>
                                            <dd class="mt-1 text-xs text-gray-500"><?php echo e(format_date($verification->declined_at, 'l m Y, h:m')); ?></dd>
                                        <?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/vidylyex/freelancerwork.online/resources/views/livewire/main/account/verification/verification.blade.php ENDPATH**/ ?>