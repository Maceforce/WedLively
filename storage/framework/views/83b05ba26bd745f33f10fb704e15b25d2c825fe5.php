...
} elseif ($_instance->childHasBeenRendered('MGBAkGh')) {
    $componentId = $_instance->getRenderedChildComponentId('MGBAkGh');
    $componentTag = $_instance->getRenderedChildComponentTagName('MGBAkGh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MGBAkGh');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('MGBAkGh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('MSpruLJ')) {
    $componentId = $_instance->getRenderedChildComponentId('MSpruLJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('MSpruLJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MSpruLJ');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('MSpruLJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://freelancerwork.online/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH /home/vidylyex/freelancerwork.online/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>