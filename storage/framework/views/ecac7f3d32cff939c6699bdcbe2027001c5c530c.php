                                    ...
                                    <div class="bg-gray-50 dark:bg-zinc-600 border-b sm:rounded-t-md flex items-center p-4 sm:p-6 sm:grid sm:grid-cols-4 sm:gap-x-6 dark:border-zinc-600">
                                        ...
                                        <dl class="flex-1 grid grid-cols-2 gap-x-6 text-sm sm:col-span-3 sm:grid-cols-2 lg:col-span-2">
                                            ...
                                            <div>
                                                ...
                                                <dd class="mt-2 text-gray-500 dark:text-gray-50 text-xs"><?php echo e(format_date($order->placed_at, 'F j, Y h:i A')); ?></dd>
                                            </div>
                                                                                ...
                                                                                <?php switch($item->status):
                                                                                    ...
                                                                                    <?php case ('delivered'): ?>
                                                                                        ...
                                                                                        <div id="orders-<?php echo e($order->uid); ?>-item-<?php echo e($item->id); ?>-status-delivered" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                                            <?php echo e(format_date($item->delivered_at, 'F j, Y h:i A')); ?>
...
</main><?php /**PATH /home/vidylyex/freelancerwork.online/resources/views/livewire/main/account/orders/orders.blade.php ENDPATH**/ ?>