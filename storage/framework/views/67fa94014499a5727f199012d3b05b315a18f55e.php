...
} elseif ($_instance->childHasBeenRendered('JELvVn5')) {
    $componentId = $_instance->getRenderedChildComponentId('JELvVn5');
    $componentTag = $_instance->getRenderedChildComponentTagName('JELvVn5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JELvVn5');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('JELvVn5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('EuPCXlE')) {
    $componentId = $_instance->getRenderedChildComponentId('EuPCXlE');
    $componentTag = $_instance->getRenderedChildComponentTagName('EuPCXlE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EuPCXlE');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('EuPCXlE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="http://localhost/freeluncer2/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH C:\xampp\htdocs\freeluncer2\resources\views/livewire/main/layout/app.blade.php ENDPATH**/ ?>