                    ...
                    <div class="fixed top-0 ltr:left-0 rtl:right-0 hidden p-6 lg:block lg:px-12">
                        <?php if(settings('general')->logo_dark): ?>
                            <a href="<?php echo e(url('/')); ?>" class="flex items-center">
                                <img style="filter: brightness(0) invert(1); width: 230px;" src="<?php echo e(src(settings('general')->logo_dark)); ?>" alt="<?php echo e(settings('general')->title); ?>" style="height: <?php echo e(settings('appearance')->sizes['header_desktop_logo_height']); ?>px;">
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(url('/')); ?>" class="flex items-center">
                                <img style="filter: brightness(0) invert(1); width: 230px;" src="<?php echo e(src(settings('general')->logo)); ?>" alt="<?php echo e(settings('general')->title); ?>" style="height: <?php echo e(settings('appearance')->sizes['header_desktop_logo_height']); ?>px;">
                            </a>
                        <?php endif; ?>
                    </div>
...
</html><?php /**PATH /home/vidylyex/freelancerwork.online/resources/views/livewire/main/auth/layout/auth.blade.php ENDPATH**/ ?>