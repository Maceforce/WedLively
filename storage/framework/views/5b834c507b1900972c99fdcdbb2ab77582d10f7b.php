...
} elseif ($_instance->childHasBeenRendered('vKgJcNF')) {
    $componentId = $_instance->getRenderedChildComponentId('vKgJcNF');
    $componentTag = $_instance->getRenderedChildComponentTagName('vKgJcNF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vKgJcNF');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('vKgJcNF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('dfKNgo9')) {
    $componentId = $_instance->getRenderedChildComponentId('dfKNgo9');
    $componentTag = $_instance->getRenderedChildComponentTagName('dfKNgo9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dfKNgo9');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('dfKNgo9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="http://localhost/freeluncer2/wireui/assets/scripts?id=be97ebae74d62aa4c86689a6528b707f" defer ></script>
...
<?php /**PATH C:\xampp\htdocs\freeluncer2\resources\views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>