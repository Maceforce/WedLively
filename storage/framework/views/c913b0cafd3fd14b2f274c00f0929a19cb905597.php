<div class="gig-card" x-data="window._<?php echo e($gig->uid); ?>" dir="<?php echo e(config()->get('direction')); ?>">
    <div class="bg-white dark:bg-zinc-800 shadow-sm ring-1 ring-gray-200 dark:ring-zinc-800">
        ...
        <div class="px-4 pb-4 mt-4">
                    ...
                    <a href="<?php echo e(url('profile', $gig->owner->username)); ?>" target="_blank" class="flex-shrink-0 group block">
                        <div class="flex items-center">
                            <span class="inline-block relative">
                                <img class="h-9 w-9  object-cover lazy shadow-sm" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($gig->owner->avatar)); ?>" alt="<?php echo e($gig->owner->username); ?>">
                            </span>
                        <div class="ltr:ml-3 rtl:mr-3">
                            <div class="text-gray-800 dark:text-gray-200 hover:text-gray-900 dark:hover:text-gray-300 flex items-center mb-0.5 font-extrabold tracking-wide text-[13px]">
                                ...
                                <?php if($gig->owner->status === 'verified'): ?>
                                    ...
                                    <div id="tooltip-account-verified-<?php echo e($gig->uid); ?>" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900  shadow-sm opacity-0 tooltip dark:bg-gray-700">
            ...
            <a href="<?php echo e(url('service', $gig->slug)); ?>" class="gig-card-title font-semibold dark:text-gray-100 hover:text-red-500 text-gray-800 dark:hover:text-white mb-5 !overflow-hidden">
        ...
        <div class="px-3 py-2 border-t border-gray-50 dark:border-zinc-700 text-right sm:px-4  flex justify-between bg-red-400">

            <div class="flex items-center">

                
                <button <?php if(auth()->guard()->check()): ?> <?php if($favorite): ?> wire:click="removeFromFavorite('<?php echo e($gig->uid); ?>')" wire:target="removeFromFavorite('<?php echo e($gig->uid); ?>')" <?php else: ?> wire:click="addToFavorite('<?php echo e($gig->uid); ?>')" wire:target="addToFavorite('<?php echo e($gig->uid); ?>')" <?php endif; ?> wire:loading.attr="disabled" <?php endif; ?> <?php if(auth()->guard()->guest()): ?> x-on:click="loginToAddToFavorite" <?php endif; ?> data-tooltip-target="tooltip-add-to-favorites-<?php echo e($gig->uid); ?>" class="h-8 w-8  flex items-center justify-center -ml-1 focus:outline-none visited:outline-none text-white">
                ...
                <div id="tooltip-add-to-favorites-<?php echo e($gig->uid); ?>" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900  shadow-sm opacity-0 tooltip dark:bg-gray-700">
                    <?php if($favorite): ?>
            ...
            <div class="gig-card-price">
                <p class="text-white dark:!text-zinc-200 mb-1 text-sm"><?php echo e(__('messages.t_starting_at')); ?></p>
                <p class=" ltr:text-right rtl:text-left dark:!text-white text-white mb-0 text-md font-bold"><?php echo money($gig->price, settings('currency')->code, true); ?></p>
            </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\WedLively\resources\views/livewire/main/cards/gig.blade.php ENDPATH**/ ?>