...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="text" x-model="form.phone" class="<?php echo e($errors->first('phone') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter phone number">
...
unset($__errorArgs, $__bag); ?>
			...
			<div class="mt-6">
				<div class="list-disc list-inside text-slate-500 text-[13px] space-y-2">
					...
					<!-- <li> -->
					<p class="nmy">Already a member? <a class="hover:text-slate-600 hover:underline link-color" href="<?php echo e(url('auth/login')); ?>">
					Log in here
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\freeluncer\resources\views/livewire/main/auth/register.blade.php ENDPATH**/ ?>