...
} elseif ($_instance->childHasBeenRendered('wZSlWOZ')) {
    $componentId = $_instance->getRenderedChildComponentId('wZSlWOZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('wZSlWOZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wZSlWOZ');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('wZSlWOZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('cFeJcKK')) {
    $componentId = $_instance->getRenderedChildComponentId('cFeJcKK');
    $componentTag = $_instance->getRenderedChildComponentTagName('cFeJcKK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cFeJcKK');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('cFeJcKK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\freeluncer\resources\views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>