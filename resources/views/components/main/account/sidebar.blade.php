...
<nav class="w-full {{ $class ? $class : '' }}">
    ...
    @php
        $link_active_class = 'bg-primary-100/25 border-red-400 text-red-400 dark:text-white hover:bg-primary-100/25 hover:text-gray-500';
        ...
        $icon_active_class = 'text-red-400 dark:text-gray-50 group-hover:text-red-400 dark:group-hover:text-white';
    ...
    <div class="border-b border-gray-100 dark:border-zinc-600">
        ...
        <a href="{{ url('account/settings') }}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
                class="{{ Request::is('account/settings') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600"
            ...
            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_account_settings') }} </span>
        ...
        <a href="{{ url('account/profile') }}"
            ...
            {{-- icon --}}
            <svg xmlns="http://www.w3.org/2000/svg"
                class="{{ Request::is('account/profile') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_edit_profile') }} </span>
        ...
        <a href="{{ url('account/password') }}"
            ...
            {{-- icon --}}
            <svg xmlns="http://www.w3.org/2000/svg"
                class="{{ Request::is('account/password') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_update_password') }} </span>
    ...
    <div class="border-b border-gray-100 dark:border-zinc-600">
        ...
        @if (settings('projects')->is_enabled)
            <a href="{{ url('account/projects') }}" class="{{ Request::is('account/projects') ? $link_active_class : $link_basic_class }} group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">
                ...
                {{-- icon --}}
                <svg class="{{ Request::is('account/projects') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <path stroke-linecap="round" stroke-linejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>

                {{-- text --}}
                <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_my_projects') }} </span>
        ...
        <a href="{{ url('account/deposit') }}" class="{{ Request::is('account/deposit') ? $link_active_class : $link_basic_class }} group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">
            ...
            {{-- icon --}}
            <svg class="{{ Request::is('account/deposit') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <path stroke-linecap="round" stroke-linejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>

            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_deposit') }} </span>
        ...
        <a href="{{ url('account/orders') }}"
            ...
            {{-- icon --}}
            <svg xmlns="http://www.w3.org/2000/svg"
                class="{{ Request::is('account/orders') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_my_orders') }} </span>
        ...
        <a href="{{ url('inbox') }}"
            ...
            {{-- icon --}}
            <svg xmlns="http://www.w3.org/2000/svg"
                class="{{ Request::is('inbox') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_my_messages') }} </span>
        ...
        <a href="{{ url('account/reviews') }}"
            ...
            {{-- icon --}}
            <svg xmlns="http://www.w3.org/2000/svg"
                class="{{ Request::is('account/reviews') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_my_reviews') }} </span>
        ...
        <a href="{{ url('account/refunds') }}"
            ...
            {{-- icon --}}
            <svg xmlns="http://www.w3.org/2000/svg" class="{{ Request::is('account/refunds') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <path stroke-linecap="round" stroke-linejoin="round" d="M16 15v-1a4 4 0 00-4-4H8m0 0l3 3m-3-3l3-3m9 14V5a2 2 0 00-2-2H6a2 2 0 00-2 2v16l4-2 4 2 4-2 4 2z"/></svg>

            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_my_refunds') }} </span>
        ...
        <a href="{{ url('account/favorite') }}"
            ...
            {{-- icon --}}
            <svg xmlns="http://www.w3.org/2000/svg"
                class="{{ Request::is('account/favorite') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_favorite_list') }} </span>
    ...
    <div class="border-b border-gray-100 dark:border-zinc-600">
        ...
        <a href="{{ url('account/billing') }}"
            ...
            {{-- icon --}}
            <svg xmlns="http://www.w3.org/2000/svg"
                class="{{ Request::is('account/billing') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_billing_information') }} </span>
        ...
        <a href="{{ url('account/verification') }}"
            ...
            {{-- icon --}}
            <svg xmlns="http://www.w3.org/2000/svg"
                class="{{ Request::is('account/verification') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- text --}}
            <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_verification_center') }} </span>
    ...
    <a href="{{ url('auth/logout') }}"
        ...
        {{-- icon --}}
        <svg xmlns="http://www.w3.org/2000/svg"
            class="group-hover:text-red-600 {{ Request::is('account/logout') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5 group-hover:text-red-600"
            fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        {{-- text --}}
        <span class="truncate text-sm font-semibold group-hover:text-red-600"> {{ __('messages.t_logout') }} </span>
