    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-5 gap-y-6">
            ...
            <div class="w-full relative h-fit">
                ...
                {{-- Bid card --}}
                <div class="rounded-lg bg-white shadow-sm border-gray-200 border relative mb-4 dark:bg-zinc-800 dark:shadow-none px-4 py-5 sm:px-6 {{ $subscription->bid->is_highlight ? 'ltr:border-l-8 rtl:border-l-8 border-primary-400 dark:border-zinc-600' : '' }}">
