                        ...
                        <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 md:rtl:space-x-reverse sm:mb-0">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ url('seller/home') }}" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-700 hover:text-gray-500 md:ltr:ml-2 md:rtl:mr-2 dark:text-zinc-300 dark:hover:text-white s">
