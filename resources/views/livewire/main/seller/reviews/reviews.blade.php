                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-52 rtl:text-right">
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    <div>
                                        ...
                                        {{-- Title --}}
                                        <a href="{{ url('service', $review->gig->slug) }}" class="font-medium whitespace-nowrap truncate block max-w-[240px] hover:text-gray-500 dark:text-white text-sm" title="{{ $review->gig->title }}">
                                            {{ $review->gig->title }}
                                        </a>
