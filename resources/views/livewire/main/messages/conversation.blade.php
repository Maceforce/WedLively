                        ...
                        <div class="msg-detail">
                            <div class="msg-username flex items-center">
                                ...
                                @if ($c->unreadMessages()->count() > 0)
                                    <div class="flex items-center justify-center w-5 h-5 pt-[1px] bg-red-400 text-[11px] font-medium text-white ltr:ml-2 rtl:mr-2 rounded-full">
                    ...
                    @if ($conversation->status === 'active')
                        ...
                        <div>
                            ...
                            <div wire:loading wire:target="send">
                                <div class="w-10 h-10 flex items-center justify-center rounded-md bg-red-400 text-white">
                            ...
                            <div wire:loading.remove wire:target="send" wire:click="send" class="cursor-pointer">
                                ...
                                {{-- LTR --}}
                                <div class="w-10 h-10 items-center justify-center rounded-md bg-red-400 text-white ltr:flex rtl:hidden">
                                ...
                                {{-- RTL --}}
                                <div class="w-10 h-10 items-center justify-center rounded-md bg-red-400 text-white ltr:hidden rtl:flex">
