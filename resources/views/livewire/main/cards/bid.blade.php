<div class="w-full relative">
    ...
    {{-- Bid card --}}
    <div class="relative bg-white dark:bg-zinc-800 shadow rounded-lg px-4 py-5 sm:px-6 mt-6 {{ $view_data['bid']['is_highlight'] ? 'ltr:border-l-8 rtl:border-l-8 border-primary-400 dark:border-zinc-700' : '' }}">
