<div class="relative my-4 pt-12 pb-20 px-4 sm:px-6 lg:pb-28 lg:px-8 shadow-sm bg-white border border-gray-100 dark:border-zinc-700">
	<div class="relative max-w-6xl mx-auto">
		...
		<div class="mt-12 max-w-lg mx-auto grid gap-8 lg:grid-cols-4 lg:max-w-none">
            ...
            @forelse ($articles as $article)
                <div class="flex flex-col shadow-md overflow-hidden">
                    ...
                    <div class="flex-1 bg-gray-100 dark:bg-zinc-800 p-6 flex flex-col justify-between">
                        <div class="flex-1">
                            ...
                            <a href="{{ url('blog', $article->slug) }}" class="block mt-2 truncate overflow-hidden" style="text-overflow: ellipsis;">
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-200 hover:text-red-500 truncate">{{ $article->title }}</p>
                            </a>
                        </div>
                    </div>
                </div>
            @empty
                ...
                {{-- No data right now --}}
                <div class="bg-blue-50 p-4 col-span-12">
                    <div class="flex">
