	...
	<div class="mt-3">
		...
		<div class="w-full relative">
				...
				<form x-data="window.zyKtAkZuKbBmbfC" x-on:submit.prevent="login" class="grid grid-cols-12 md:gap-x-6 gap-y-3">
					...
					<div class="col-span-12">
						<div class="relative w-full shadow-sm">
							...
							{{-- Input --}}
							<input type="email" x-model="form.email" class="{{ $errors->first('email') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm font-medium block w-full ltr:pr-12 rtl:pl-12 p-3 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="{{ __('messages.t_enter_email_address') }}">
					...
					<div class="col-span-12">
						<div class="relative w-full shadow-sm">
							...
							{{-- Input --}}
							<input type="password" x-model="form.password" class="{{ $errors->first('password') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm font-medium block w-full ltr:pr-12 rtl:pl-12 p-3 placeholder:font-normal  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="{{ __('messages.t_enter_password') }}">
			...
			<div class="mt-6 text-center">
				...
				{{-- Forgot password --}}
					<!-- <li> -->
						<a class="link-color hover:text-gray-800 hover:underline font-medium transition-colors duration-300" href="{{ url('auth/password/reset') }}">
					...
					{{-- Create new account --}}
					<!-- <li> -->
					<p class="nmy font-medium">Not a member Yet?<a class="link-color hover:text-gray-800 hover:underline font-medium transition-colors duration-300" href="{{ url('auth/register') }}">
