        ...
        <div class="grid md:flex justify-center md:justify-between items-center border-t-2 border-gray-50 dark:border-zinc-700 pt-4">
            ...
            <div class="mb-2">
                <div class="flex items-center space-x-2">
                    ...
                    <a href="{{ settings('footer')->social_facebook }}" target="_blank" data-tooltip-target="tooltip-follow-us-facebook" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 group p-2 rtl:ml-2">
                    ...
                    <a href="{{ settings('footer')->social_twitter }}" target="_blank" data-tooltip-target="tooltip-follow-us-twitter" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 group p-2">
                    ...
                    <a href="{{ settings('footer')->social_instagram }}" target="_blank" data-tooltip-target="tooltip-follow-us-instagram" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 group p-2">
                    ...
                    <a href="{{ settings('footer')->social_pinterest }}" target="_blank" data-tooltip-target="tooltip-follow-us-pinterest" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 group p-2">
                    ...
                    <a href="{{ settings('footer')->social_linkedin }}" target="_blank" data-tooltip-target="tooltip-follow-us-linkedin" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 group p-2">
                    ...
                    <a href="{{ settings('footer')->social_github }}" target="_blank" data-tooltip-target="tooltip-follow-us-github" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 group p-2">
                    ...
                    <a href="{{ settings('footer')->social_youtube }}" target="_blank" data-tooltip-target="tooltip-follow-us-youtube" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 group p-2">
