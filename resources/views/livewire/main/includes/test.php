...
<ul class="nav-linking relative flex items-center justify-center overflow-y-auto transition-colors duration-300 rtl:space-x-reverse scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-zinc-600 scrollbar-track-gray-50 dark:scrollbar-track-zinc-400" style="gap:30px">
                    ...
                    @endforeach
                    <li class="inline-block flex-shrink-0 border-b-2 border-transparent hover:border-primary-600 focus:outline-none focus:ring-0 relative">
                    <button data-popover-target="popover-subcategories-{{ $category->uidmenu }}" data-popover-trigger="hover" class="block text-[13px] font-medium text-black dark:text-white dark:group-hover:text-white group-hover:text-primary-600 py-2 focus:outline-none focus:ring-0">menu</button>
                    </li>
                </ul>

                <!-- mega menu -->
                <div data-popover id="popover-subcategories-{{ $category->uidmenu }}" data-popover-placement="bottom" role="tooltip" class="mega-menu absolute z-10 invisible opacity-0 inline-block w-full text-sm font-light text-gray-500 transition-opacity duration-300 bg-white rounded-md shadow-xl dark:text-zinc-400 dark:bg-zinc-800 translate-unset">
                <div class="rows">
                    ...
                    <div class="col-lg-4 bg-warning p-4">
                        ...
                        <div class="d-flex gap-3 mb-4">
                            <img src="../public/img/home/wedding.jpg" class="rounded-3 object-fit-cover" width="130px" height="auto" alt="">
                            <div>
                        ...
                        <div class="d-flex gap-3 mb-5">
                            <img src="../public/img/home/planning.jpg" class="rounded-3 object-fit-cover" width="130px" height="auto" alt="">
                            <div>
                                <h6 class="text-black">Article Title</h6>
                                <p class="py-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                                <a href="#" class="text-black d-flex align-items-end gap-1 hover:underline">Read more</a>
                        ...
                        <a href="#" class="text-black d-flex align-items-center gap-1 fs-6 hover:underline">See All Articles <img src="../public/img/home/arrow-right.svg" alt=""></a>
                    </div>
                </div>
                </div>
                <!-- / mega menu -->
            ...
            <div class="nav-btn-group min-w-fit ltr:sm:ml-10 rtl:sm:mr-10 flex items-center font-medium text-sm transition-all duration-200">
                ...
                {{-- Become a seller --}}
                @guest
                <a href="{{ url('start_selling') }}" class="border border-black font-medium focus:outline-none hover:underline h-9 leading-6 py-2 px-3 mr-4 text-black">
                ...
                {{-- Switch selling --}}
                <a href="{{ url('seller/home') }}" class="text-primary-600 hover:text-primary-700 hover:underline transition-colors duration-300 py-2 px-4 hidden lg:block dark:text-gray-100 dark:hover:text-white">
                ...
                {{-- Switch buying --}}
                <a href="{{ url('/') }}" class="text-primary-600 hover:text-primary-700 hover:underline transition-colors duration-300 py-2 px-4 hidden lg:block dark:text-gray-100 dark:hover:text-white">
                ...
                {{-- Sign in --}}
                @guest
                <a href="{{ url('auth/login') }}" class="text-white bg-black transition-colors duration-300 hover:underline py-2 px-4 hidden md:block dark:text-white dark:bg-black hover:bg-gray-800">
                    LOGIN
                ...
                <a href="{{ url('auth/register') }}" class="py-2 px-4 ml-4 text-white transition-colors duration-300 hover:underline hidden md:inline-block dark:text-white dark:hover:text-white"
