                                    ...
                                    <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="employer-dashboard-project-milestones-{{ $p->uid }}">
                                        ...
                                        <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                            <div class="flex items-center justify-center space-x-2 rtl:space-x-reverse">
                                                ...
                                                {{-- Pay --}}
                                                @if ($p->status === 'request')
                                                    <button wire:click="confirmPay('{{ $p->uid }}')" type="button" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 text-sm rounded border-gray-300 bg-white text-gray-600 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none" data-tooltip-target="tooltip-actions-pay-{{ $p->uid }}">
                        ...
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            ...
                            <div class="space-y-0.5">
                                ...
                                <div class="flex items-center">
                                    ...
                                    {{-- Username --}}
                                    <a href="{{ url('profile', $project->awarded_bid->user->username) }}" class="font-medium text-gray-500 text-[13px] hover:text-primary-600 focus:text-primary-600 inline-flex items-center">
