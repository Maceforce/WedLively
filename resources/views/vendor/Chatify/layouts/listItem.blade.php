...
@if($get == 'saved')
    <table class="messenger-list-item m-li-divider !border-b-gray-100 dark:!border-zinc-700" data-contact="{{ strtolower(auth()->user()->uid) }}" data-contact-id="{{ auth()->id() }}">
        <tr data-action="0">
            {{-- Avatar side --}}
            <td>
            <div class="av-m flex flex-col items-center justify-center bg-slate-50 rounded-full text-center">
                <svg class="w-6 h-6 text-red-400" stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><desc></desc><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M9 4h6a2 2 0 0 1 2 2v14l-5 -3l-5 3v-14a2 2 0 0 1 2 -2"></path></svg>
            </div>
            </td>
            {{-- center side --}}
            <td>
