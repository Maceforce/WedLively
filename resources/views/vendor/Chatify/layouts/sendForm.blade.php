<div class="messenger-sendCard" x-data="window.ieFgUjXUHsNGdOd" x-init="initialize">
    ...
    {{-- Send message form --}}
    <form id="message-form" method="POST" action="{{ route('send.message') }}" enctype="multipart/form-data" class="items-center flex flex-row">
    ...
    function ieFgUjXUHsNGdOd() {
        return {
            ...
            emojis() {
                ...
                const options = { 
                    set            : 'twitter',
                    theme          : "{{ Cookie::get('dark_mode') === 'enabled' ? 'dark' : 'light' }}",
                    dynamicWidth   : true,
